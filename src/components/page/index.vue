<template>
    <div>
        ...
        <app-body style='width:100%;'>
            <br>
            <template>
                <el-carousel :interval='4000' height='380px' style='width:100%;' type='card'>
            ...
            <div style='min-height: 85vh;padding: 20px;'>
                ...
                <div style='margin: 0 20px;'>
                    <el-row :gutter='30'>
                        <el-col v-for='(idle,index) in idleList' :key='index' :span='6'>
            ...
            this.$api.findAllCarouselMap().then(res => {
                if (res.status_code == 1) {
                    ...
                    this.pictureList.forEach((item) => {
                        let pic = JSON.parse(item.pictureList).pictureList[0];
                        this.imageData.push({ img: pic });
                    });
                } else {
