<template>
    <div class="header">
        <div class="header-container">
            <div class="app-name">
                <router-link to="/">基于SpringBoot的二手交易系统</router-link>
            </div>
            <div class="search-container">
                <el-input placeholder="搜二手闲置..." v-model="searchValue" @keyup.enter.native="searchIdle">
                    <el-button slot="append" icon="el-icon-search" @click="searchIdle"></el-button>
                </el-input>
            </div>
            <el-button type="primary" icon="el-icon-plus"  @click="toRelease">发布商品</el-button>
            <el-button type="primary" icon="el-icon-chat-dot-round" @click="toMessage">我的消息</el-button>
            <router-link v-if="!isLogin" class="user-name-text" to="/login">用户登录</router-link>
